...
class Student{
    ...
    Student(Student s1){
        ...
        for(int i=0; i<marks.length; i++){
            this.marks[i]= s1.marks[i]; //Here our array values copy in s2 one by one, we do not directly copy all the values, it creates a new array in which these values are copied.
        }
